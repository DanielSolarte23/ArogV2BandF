...
import { TOKEN_SECRET } from "../config/config.js"; // Importa la clave secreta usada para firmar el token
...
export function createAccesToken(payload) {
    ...
    return new Promise((resolve, reject) => {
        ...
        jwt.sign(
            ...
            TOKEN_SECRET, // La clave secreta que se utiliza para firmar el token y asegurar su autenticidad
            {
