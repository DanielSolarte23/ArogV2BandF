...
export default function BarraLateral() {
  ...
  return (
    <>
      ...
      <div
        ref={sidebarRef}
        className="sidebar shadow-xl h-full scrollbar bottom-0 xl:left-0 p-2 w-1/5 overflow-y-auto text-center bg-white transition-all duration-700"
      >
        ...
        >
          <Link className="w-full h-full" to="rutas">
